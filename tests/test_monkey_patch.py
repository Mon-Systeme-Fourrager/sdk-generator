...
""")
    ...
    def test_generate_imports_full_package(self, tmp_path):
        ...
        assert "from .api_config import APIConfig, HTTPException, configure_api  # noqa: F401" in imports
        assert "from .models.user import User, UserProfile  # noqa: F401" in imports
        assert "from .services.user_service import create_user, get_user  # noqa: F401" in imports
...
""")
        ...
        assert "from .api_config import APIConfig, HTTPException  # noqa: F401" in init_content
        assert "from .models.user_models import CreateUserRequest, User  # noqa: F401" in init_content
        assert "from .services.user_service import create_user, get_users  # noqa: F401" in init_content
...
""")
        ...
        assert "from .api_config import TestClass, test_function  # noqa: F401" in init_content
